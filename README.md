...
Redo of Awesome books with ES6.
Awesome books: Basic website that allows users to add/remove books from a list. Achieve it by using JavaScript objects, arrays and basic events to dynamically modifying the DOM.
